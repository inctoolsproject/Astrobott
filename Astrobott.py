...
ki = LINETCR.LINE()
ki.login(token="EmMYnHhuh3agB6sTwovc.zHFKhL148jLHR5sDbqv5Va.x+DzLFNgKNrekVTcBbH8yqG5YLiXHotzJ3pxOpcDaBc=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EmmhjsATS7SvOlaDAL80.w1AAyeHdY4wIEr+vDQ0O4a.s4Kv6l8hNVX+TLoGcviUGWFS6DiSb8sXxelYCqCt8JM=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EmsEA6ApMILUgwM9N2Nf.X41OO7JOJ+gHSo4RghhppW.DFx/yW5ymvI+NSFvRch707O+S7zNS1UGxZSBOlNnrdE=")
kc.loginResult()

ks = LINETCR.LINE()
ks.login(token="Emq6pf90PmSvTaMeQR70.wEkE9nZQ4a/dHXXW7aqL4a.LxamJGVUlNqxXOHZ7EMJN8SmnguIeQqcASnrZsbivfg=")
ks.loginResult()

ka = LINETCR.LINE()
ka.login(token="Em7LINEg7nSilu0K3Jtd.M/LDsreIlenpUVSHvziH3q.UHZX/MJ/ae6QIOT9L2+Ie7fiI5ejmhyabni1xxAvwGc=")
ka.loginResult()

kb = LINETCR.LINE()
kb.login(token="EmT5rxGYEqF4k43ZjLX5.WEZ1ykCHSpiHLoZCIhN3bq.1nTLoMHXSTz1NU/wMiUw4KoktcMK24DwwUmMjhvHy88=")
kb.loginResult()

ko = LINETCR.LINE()
ko.login(token="Em4B8qkkxT70WX97ERk6.ywuYMgtz9n/vngujgBi1bG.R3sHskv0ND44JwlmoqIVLrVjysFt0rth9onXw8lQ78c=")
ko.loginResult()

ke = LINETCR.LINE()
ke.login(token="EmXFmSosp2Yirz8x5wH8.x1Qjasx3kZxqeUuROzwBwa.7ZVccBJtu97Uv+9EQilC7/kevY9+3PLe5hB/aYfutcI=")
ke.loginResult()

ku = LINETCR.LINE()
ku.login(token="Em2GYy6qMGslk2PJbWEd.dduf+qm/ZHHvz2lCNvW9pq.R/ahr0BQ5Gkpix5IniXJN3MAOJyYCHq/ZhUgN1SmsNM=")
ku.loginResult()
...
helpMessage =""" [ASTROBOT] BOT Menu V.3  􀔃􀄆red check mark􏿿
...
[nama bot join] Invite Bot
[Bye namabot]  Leave Bot
[Astrobot!] Contact Bot
"""
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"ASTROBOT")

                msg.contentType = 13
                msg.contentMetadata = {'mid': Amid}
                ki.sendMessage(msg)
                ki.sendText(msg.to,"ASTROBOT")

                msg.contentType = 13
                msg.contentMetadata = {'mid': Bmid}
                kk.sendMessage(msg)
                kk.sendText(msg.to,"ASTROBOT")
                
                msg.contentType = 13
                msg.contentMetadata = {'mid': Cmid}
                kc.sendMessage(msg)
                kc.sendText(msg.to,"ASTROBOT")
                
                msg.contentType = 13
                msg.contentMetadata = {'mid': Dmid}
                ks.sendMessage(msg)
                ks.sendText(msg.to,"ASTROBOT")
                
                msg.contentType = 13
                msg.contentMetadata = {'mid': Emid}
                ka.sendMessage(msg)
                ka.sendText(msg.to,"ASTROBOT")
                
                msg.contentType = 13
                msg.contentMetadata = {'mid': Fmid}
                kb.sendMessage(msg)
                kb.sendText(msg.to,"ASTROBOT")
                
                msg.contentType = 13
                msg.contentMetadata = {'mid': Gmid}
                ko.sendMessage(msg)
                ko.sendText(msg.to,"ASTROBOT")
                
                msg.contentType = 13
                msg.contentMetadata = {'mid': Hmid}
                ke.sendMessage(msg)
                ke.sendText(msg.to,"ASTROBOT")
            elif msg.text in ["Me"]:
                msg.contentType = 13
		...
		for ticket_id in n_links:
            ...
            elif "Astrobot v1" == msg.text:
                cl.sendText(msg.to,mid)
            elif "Astrobot v2" == msg.text:
                ki.sendText(msg.to,Amid)
            elif "Astrobot v3" == msg.text:
                kk.sendText(msg.to,Bmid)
            elif "Astrobot v4" == msg.text:
                kc.sendText(msg.to,Cmid)
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            ...
            elif msg.text in ["Astrobot v1 join"]:
            ...
            elif msg.text in ["Astrobot v2 join"]:
              if msg.from_ in admin:
                  x = cl.getGroup(msg.to)
                  x.preventJoinByTicket = False
                  cl.updateGroup(x)
            ...
            elif msg.text in ["Astrobot v3 join"]:
              if msg.from_ in admin:
                  x = cl.getGroup(msg.to)
                  x.preventJoinByTicket = False
                  cl.updateGroup(x)
            ...
            elif msg.text in ["Astrobot v4 join"]:
              if msg.from_ in admin:
                  X = cl.getGroup(msg.to)
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
            elif msg.text in ["Bye Astrobot v1"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        pass
            elif msg.text in ["Bye Astrobot v2"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        pass
            elif msg.text in ["Bye Astrobo v4"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    ki.sendText(msg.to,"Dark Spear telah selesai!")
                                    kc.sendText(msg.to,"Mantap tuan")
